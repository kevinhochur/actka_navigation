...
pi.set_PWM_frequency(5, 100)
pi.set_PWM_frequency(6, 100)
...
def callback(msg):
    ...
    pi.set_PWM_dutycycle(5, r_moter_22)
    pi.set_PWM_dutycycle(6, r_moter_23)
    pi.set_PWM_dutycycle(23, l_moter_24)
    pi.set_PWM_dutycycle(24, l_moter_25)
